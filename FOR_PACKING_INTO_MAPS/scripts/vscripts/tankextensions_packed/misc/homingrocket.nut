...
function HomingThink()
{
	...
	if(!Target || !Target.IsValid() || !Target.IsAlive() || Target.GetTeam() == self.GetTeam() || TankExtPacked.IsPlayerStealthedOrDisguised(Target) || (MaxAimError == -1 ? false : !IsEntityInAim(Target))) FindTarget()
...
TankExtPacked.AddThinkToEnt(self, "HomingThink")