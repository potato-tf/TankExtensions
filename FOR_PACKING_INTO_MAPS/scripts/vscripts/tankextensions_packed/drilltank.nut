...
::DrillTankEvents <- {
	...
	function OnScriptHook_OnTakeDamage(params)
	{
		...
		{
			local DrillScope = TankExtPacked.GetMultiScopeTable(hAttacker, "drilltank")
...
TankExtPacked.NewTankType("drilltank", {
	function OnSpawn()
	{
		EmitSoundEx({
		...
		TankExtPacked.SetParentArray([hModel, hDrillHurt], self)
