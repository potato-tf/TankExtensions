...
TankExtPacked.PrecacheSound(COMBATTANK_ROCKETPOD_SND_FIRE)

TankExtPacked.CombatTankWeapons["rocketpod"] <- {
...
TankExtPacked.CombatTankWeapons["rocketpod_homing"] <- {
	Model = COMBATTANK_ROCKETPOD_MODEL
	function OnSpawn()
	{
		TankExtPacked.CombatTankWeapons["rocketpod"].OnSpawn.call(this)
		bHoming = true
	}
}