...
TankExtPacked.PrecacheSound(EXAMPLETANK_SND_ENGINE)
TankExtPacked.PrecacheSound(EXAMPLETANK_SND_PING)
...
TankExtPacked.NewTankType("exampletank", {
	Color              = "110 110 110"
	DisableBomb        = 0
	...
	function OnSpawn()
	{
		...
		TankExtPacked.SetParentArray([hProp], self)
