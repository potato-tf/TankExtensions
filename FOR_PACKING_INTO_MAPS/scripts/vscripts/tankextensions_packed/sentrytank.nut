...
TankExtPacked.NewTankType("sentrytank", {
	Model = {
	...
	function OnSpawn()
	{
		...
		local hSentry = SpawnEntityFromTable("obj_sentrygun",
		{
			...
			vscripts       = "tankextensions_packed/misc/sentry_removesapper"
		})
		TankExtPacked.SetParentArray([hSentry], self, bModelHasAttachment ? "building_attachment" : null)
