...
TankExt.NewTankType("helicopter*", {
	...
	function OnSpawn()
	{
		...
		TankExt.SetParentArray([hTurret, hMimicRocket, hMimicSticky, hHurt], hModel)
		...
		function Think()
		{
			...
			else
			{
				...
				local flYawGoal = hTarget && !bDeploying ? TankExt.VectorAngles(vecTarget - vecOrigin).y : angCurrent.y
